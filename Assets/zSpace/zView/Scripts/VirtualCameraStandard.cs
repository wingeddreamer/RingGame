...
namespace zSpace.zView
{
    public class VirtualCameraStandard : VirtualCamera
    {
        ...
        public override void Render(ZView zView, IntPtr connection, IntPtr receivedFrame)
        {
            ...
            {
                _centerCamera = ZCoreProxy.Instance.GetCamera(ZCoreProxy.Eye.Center);
                if (_centerCamera == null)
                {
            ...
            if (_centerCamera != null)
            {
                _camera.CopyFrom(_centerCamera);
            }
        ...
        private void UpdateImageResolution(ZView zView, IntPtr connection)
        {
            ...
            UInt16 imageWidth = (UInt16)Screen.width;
            UInt16 imageHeight = (UInt16)Screen.height;
        ...
        private Camera        _centerCamera     = null;
