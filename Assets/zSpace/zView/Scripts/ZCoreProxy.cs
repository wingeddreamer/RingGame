...
namespace zSpace.zView
{
    ...
    public class ZCoreProxy
    {
        ...
        public Camera GetCamera(Eye eye)
        {
            if (_core == null || _getStereoCamera == null)
            {
                return null;
            }

            Component stereoCamera = (Component)_getStereoCamera.Invoke(
                _core,
                new object[]
                {
            ...
            return stereoCamera.GetComponent<Camera>();
        }
        ...
        private ZCoreProxy()
        {
            ...
            if (assembly != null)
            {
                ...
                if (_coreType != null)
                {
                    ...
                    // Get the GetStereoCamera method info.
                    if (_eyeType != null)
                    {
                        _getStereoCamera = _coreType.GetMethod(
                            "GetStereoCamera",
                            BindingFlags.Public | BindingFlags.Instance,
                            null,
                            new Type[] { _eyeType },
                        ...
                        if (_getStereoCamera == null)
                        {
                            Debug.LogError("Failed to find zSpace.Core.ZCore.GetStereoCamera method.");
                        }
                    }
        ...
        private MethodInfo _getStereoCamera             = null;
